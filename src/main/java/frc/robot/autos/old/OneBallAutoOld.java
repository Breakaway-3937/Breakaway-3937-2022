...
import frc.robot.autos.AutoStartUpFender;
import frc.robot.autos.FireShooterAuto;
...
public class OneBallAutoOld extends SequentialCommandGroup {
  /** Creates a new OneBallAuto. */
  public OneBallAutoOld(DriveTrain s_DriveTrain, LimeLight s_LimeLight, Shooter s_Shooter, Intake s_Intake, Climber s_Climber, String whichAuto) {
